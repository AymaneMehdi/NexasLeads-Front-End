      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between">
          <div className="flex flex-col items-center md:items-start mb-8 md:mb-0">
            <Link href={`/${locale}/`}>
              <h2 className="text-2xl md:text-3xl font-bold mb-2 text-[#e24545]">
                {data.logo}
              </h2>
            </Link>
            ...
            <form
              ...
              className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-2 mb-4"
            >
              <input
                value={email}
              ...
              <button
                type="submit"
                className="rounded-full bg-gradient-to-r from-[#ffd126] to-[#e24545] text-white font-bold px-4 py-2"
              >
                {data.button}
              </button>
            </form>
          ...
          <div className="flex flex-col mb-8 md:mb-0">
            ...
            <ul className="space-y-2 text-sm md:text-base">
              <li>
                <Link href={`/${locale}/`}>{data.page1}</Link>
              </li>
              <li>
                <Link href={`/${locale}/AboutUs`}>{data.page2}</Link>
              </li>
              <li>
                <Link href={`/${locale}/Blog`}>{data.page3}</Link>
              </li>
              <li>
                <Link href={`/${locale}/ContactUs`}>{data.page4}</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col mb-8 md:mb-0">
            ...
            <ul className="space-y-2 text-sm md:text-base">
              <li>
                <Link href={`/${locale}/training-and-certifications`}>
                  {data.page5}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/Business-Development`}>
                  {data.page6}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/CRM-Integrations`}>{data.page7}</Link>
              </li>
            </ul>
          </div>
        </div>
