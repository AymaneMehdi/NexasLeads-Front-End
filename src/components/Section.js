...
export default function Component() {
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-[#e24545] text-white mx-2 sm:mx-6 lg:mx-16 xl:mx-24 mt-24 sm:mt-32 lg:mt-36 pb-14 sm:pb-20 lg:pb-28 mb-10 lg:mb-20">
      <div className="flex flex-col items-center justify-center space-y-4 max-w-full sm:max-w-[90%] lg:max-w-[85%] xl:max-w-[80%]">
        ...
        <div className="flex flex-col sm:flex-row sm:space-x-4 space-y-4 sm:space-y-0">
          ...
          >
            {" "}
            <div className="flex justify-center items-center cursor-pointer group relative gap-1.5 px-8 py-4 sm:px-10 sm:py-5 bg-[#ffd126] text-gray-950 rounded-3xl hover:bg-[#f8c600] transition font-semibold shadow-md">
              {data.button}
            </div>
          </Link>
