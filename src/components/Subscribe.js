...
const NewsletterSubscription = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const url = process.env.NEXT_PUBLIC_SUBSCRIBE_API_URL;
    ...
    <div className="relative isolate overflow-hidden bg-gray-800 py-16 sm:py-24 lg:py-32">
      <div className="flex justify-center items-center h-full">
        <div className="max-w-xl text-center">
          <h2 className="text-3xl font-bold tracking-tight text-[#e24545] sm:text-4xl">
            Subscribe to our newsletter.
          </h2>
          <p className="mt-4 text-lg leading-8 text-[#e24545]">
